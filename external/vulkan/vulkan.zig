...
pub const PFN_vkCreateInstance = ?fn (?[*]const InstanceCreateInfo, ?[*]const VkAllocationCallbacks, ?[*]VkInstance) callconv(.C) VkResult;
pub const PFN_vkCreateDebugUtilsMessengerEXT = ?fn (Instance, *const DebugUtilsMessengerCreateInfoEXT, ?*const AllocationCallbacks, *DebugUtilsMessengerEXT) callconv(.C) Result;
...
pub const GLFWcharfun = fn(*GLFWwindow, u32) callconv(.C) void;
pub const GLFWkeyfun = fn(*GLFWwindow, i32, i32, i32, i32) callconv(.C) void;

// GLFW Functions
pub extern fn glfwGetError(description: *[*:0]u8) callconv(.C) i32;
...
pub extern fn glfwCreateWindow(width: c_int, height: c_int, title: ?[*]const u8, monitor: ?*GLFWmonitor, share: ?*GLFWwindow) callconv(.C) ?*GLFWwindow;
...
pub extern fn glfwGetFramebufferSize(window: *GLFWwindow, width: *c_int, height: *c_int) callconv(.C) void;
pub extern fn glfwGetWindowFrameSize(window: ?*GLFWwindow, left: ?[*]c_int, top: ?[*]c_int, right: ?[*]c_int, bottom: ?[*]c_int) callconv(.C) void;
...
pub extern fn glfwExtensionSupported(extension: ?[*]const u8) callconv(.C) c_int;
pub extern fn glfwGetProcAddress(procname: ?[*]const u8) callconv(.C) GLFWglproc;
pub extern fn glfwVulkanSupported() c_int;
pub extern fn glfwGetRequiredInstanceExtensions(count: *u32) ?[*]const [*:0]const u8;
pub extern fn glfwGetInstanceProcAddress(instance: VkInstance, procname: ?[*]const u8) callconv(.C) GLFWvkproc;
pub extern fn glfwGetPhysicalDevicePresentationSupport(instance: VkInstance, device: VkPhysicalDevice, queuefamily: u32) c_int;
pub extern fn glfwCreateWindowSurface(instance: Instance, window: *GLFWwindow, allocator: ?*const AllocationCallbacks, surface: *SurfaceKHR) callconv(.C) Result;
